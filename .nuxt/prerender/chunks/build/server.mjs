...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DtsG_QdT.mjs').then((m) => m.default || m)
  }
];
...
const createSupabaseClient = () => {
  ...
  const options2 = Authorization ? defu$1({ auth, global: { headers: { Authorization } } }, clientOptions) : defu$1({ auth }, clientOptions);
